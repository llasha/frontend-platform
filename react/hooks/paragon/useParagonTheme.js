...
exports.getDefaultThemeVariant = exports["default"] = void 0;
var _react = require("react");
var _constants = require("../../constants");
var _logging = require("../../../logging");
var _reducers = require("../../reducers");
var _utils = require("./utils");
var _useParagonThemeCore = _interopRequireDefault(require("./useParagonThemeCore"));
var _useParagonThemeUrls = _interopRequireDefault(require("./useParagonThemeUrls"));
var _useParagonThemeVariants = _interopRequireDefault(require("./useParagonThemeVariants"));
...
*
*/
var getDefaultThemeVariant = exports.getDefaultThemeVariant = function getDefaultThemeVariant(_ref) {
  ...
  var persistedSelectedParagonThemeVariant = localStorage.getItem(_constants.SELECTED_THEME_VARIANT_KEY);
...
var useParagonTheme = function useParagonTheme() {
  ...
  var paragonThemeUrls = (0, _useParagonThemeUrls["default"])();
  ...
  var _useReducer = (0, _react.useReducer)(_reducers.paragonThemeReducer, initialParagonThemeState),
  ...
  var onLoadThemeCore = (0, _react.useCallback)(function () {
  ...
  var onLoadThemeVariants = (0, _react.useCallback)(function () {
    setHasLoadedThemeVariants(true);
  }, []);

  // load the core theme CSS
  (0, _useParagonThemeCore["default"])({
    themeCore: themeCore,
    onComplete: onLoadThemeCore
  });

  // respond to system preference changes with regard to `prefers-color-scheme: dark`.
  var handleDarkModeSystemPreferenceChange = (0, _react.useCallback)(function (prefersDarkMode) {
    // Ignore system preference change if the theme variant is already set in localStorage.
    if (localStorage.getItem(_constants.SELECTED_THEME_VARIANT_KEY)) {
      return;
    }
    if (prefersDarkMode && themeVariantDefaults !== null && themeVariantDefaults !== void 0 && themeVariantDefaults.dark) {
      dispatch(_reducers.paragonThemeActions.setParagonThemeVariant(themeVariantDefaults.dark));
    } else if (!prefersDarkMode && themeVariantDefaults !== null && themeVariantDefaults !== void 0 && themeVariantDefaults.light) {
      dispatch(_reducers.paragonThemeActions.setParagonThemeVariant(themeVariantDefaults.light));
    } else {
      (0, _logging.logError)("Could not set theme variant based on system preference (prefers dark mode: ".concat(prefersDarkMode, ")"), themeVariantDefaults, themeVariants);
    }
  }, [themeVariantDefaults, themeVariants]);

  // load the theme variant(s) CSS
  (0, _useParagonThemeVariants["default"])({
    themeVariants: themeVariants,
  ...
  (0, _react.useEffect)(function () {
    ...
    var hasThemeConfig = (themeCore === null || themeCore === void 0 ? void 0 : themeCore.urls) && !(0, _utils.isEmptyObject)(themeVariants);
    if (!hasThemeConfig) {
      // no theme URLs to load, set loading to false.
      dispatch(_reducers.paragonThemeActions.setParagonThemeLoaded(true));
    }
...
var _default = exports["default"] = useParagonTheme;
