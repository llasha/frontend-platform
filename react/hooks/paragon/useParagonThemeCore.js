    ...
    var _createCoreThemeLink = function createCoreThemeLink(url) {
      ...
      coreThemeLink.onerror = function () {
        ...
        if (isFallbackThemeUrl) {
          (0, _logging.logError)('Could not load core theme fallback URL. Aborting.');
          if (isBrandOverride) {
            setIsBrandThemeCoreComplete(true);
          } else {
            setIsParagonThemeCoreComplete(true);
        ...
        if (core) {
          var coreThemeFallbackUrl = (0, _utils.fallbackThemeUrl)(core.fileName);
          (0, _logging.logInfo)("Could not load core theme CSS from ".concat(url, ". Falling back to locally installed core theme CSS: ").concat(coreThemeFallbackUrl));
          ...
          (0, _logging.logError)("Failed to load core theme CSS from ".concat(url, " or fallback URL. Aborting."));
        }
      };
...
var _default = exports["default"] = useParagonThemeCore;
