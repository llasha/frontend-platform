...
exports.handleVersionSubstitution = exports["default"] = void 0;
 ...
 */
var handleVersionSubstitution = exports.handleVersionSubstitution = function handleVersionSubstitution(_ref) {
  var url = _ref.url,
...
var useParagonThemeUrls = function useParagonThemeUrls() {
  return (0, _react.useMemo)(function () {
    ...
    if (!coreCss["default"] || (0, _utils.isEmptyObject)(themeVariantsCss) || (0, _utils.isEmptyObject)(defaultThemeVariants)) {
      ...
      if ((0, _utils.isEmptyObject)(localParagonCoreUrl) || (0, _utils.isEmptyObject)(localParagonThemeVariants)) {
        return undefined;
      }
      if (!coreCss["default"]) {
        coreCss["default"] = (0, _utils.fallbackThemeUrl)(localParagonCoreUrl === null || localParagonCoreUrl === void 0 ? void 0 : localParagonCoreUrl.fileName);
      }
      if (!coreCss.brandOverride && !(0, _utils.isEmptyObject)(localBrandCoreUrl)) {
        coreCss.brandOverride = (0, _utils.fallbackThemeUrl)(localBrandCoreUrl === null || localBrandCoreUrl === void 0 ? void 0 : localBrandCoreUrl.fileName);
      }
        ...
        if (!((_themeVariantsCss$the = themeVariantsCss[themeVariant]) !== null && _themeVariantsCss$the !== void 0 && (_themeVariantsCss$the = _themeVariantsCss$the.urls) !== null && _themeVariantsCss$the !== void 0 && _themeVariantsCss$the["default"])) {
          ...
          themeVariantsCss[themeVariant] = {
            urls: _objectSpread(_objectSpread({}, (_themeVariantsCss$the2 = themeVariantsCss[themeVariant]) === null || _themeVariantsCss$the2 === void 0 ? void 0 : _themeVariantsCss$the2.urls), {}, {
              "default": (0, _utils.fallbackThemeUrl)(fileName)
            }, rest.urls)
          };
        }
      });
        ...
        if (!((_themeVariantsCss$the3 = themeVariantsCss[themeVariant]) !== null && _themeVariantsCss$the3 !== void 0 && (_themeVariantsCss$the3 = _themeVariantsCss$the3.urls) !== null && _themeVariantsCss$the3 !== void 0 && _themeVariantsCss$the3.brandOverride)) {
          ...
          themeVariantsCss[themeVariant] = {
            urls: _objectSpread(_objectSpread({}, (_themeVariantsCss$the4 = themeVariantsCss[themeVariant]) === null || _themeVariantsCss$the4 === void 0 ? void 0 : _themeVariantsCss$the4.urls), {}, {
              brandOverride: (0, _utils.fallbackThemeUrl)(fileName)
            }, rest.urls)
          };
        }
      });
...
var _default = exports["default"] = useParagonThemeUrls;
