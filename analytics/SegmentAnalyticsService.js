...
var SegmentAnalyticsService = /*#__PURE__*/function () {
  ...
  return _createClass(SegmentAnalyticsService, [{
    ...
    value: function sendTrackingLogEvent(eventName, properties) {
      var _this2 = this;
      var snakeEventData = (0, _utils.snakeCaseObject)(properties, {
        deep: true
      });
      var serverData = {
      ...
      return this.httpClient.post(this.trackingLogApiUrl, (0, _formUrlencoded["default"])(serverData), {
        headers: {
...
var _default = exports["default"] = SegmentAnalyticsService;
