...
exports.resetLoggingService = resetLoggingService;
 ...
 *
 */
function configure(LoggingService, options) {
  _propTypes["default"].checkPropTypes(optionsShape, options, 'property', 'Logging');
  service = new LoggingService(options);
  _propTypes["default"].checkPropTypes(serviceShape, service, 'property', 'LoggingService');
  return service;
}
 ...
 */
function logInfo(infoStringOrErrorObject, customAttributes) {
 ...
 * @param {Object} [customAttributes={}]
 */
function logError(errorStringOrObject, customAttributes) {
