...
var _axiosCacheInterceptor = require("axios-cache-interceptor");
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable no-underscore-dangle */
/**
...
function _configureCache() {
  _configureCache = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
    var forageStore, forageStoreAdapter;
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.n) {
        case 0:
          _context4.n = 1;
          return _localforage["default"].defineDriver(_localforageMemoryStorageDriver["default"]);
        case 1:
          // Create `localforage` instance
          forageStore = _localforage["default"].createInstance({
            // List of drivers used
            driver: [_localforage["default"].INDEXEDDB, _localforage["default"].LOCALSTORAGE, _localforageMemoryStorageDriver["default"]._driver],
            name: 'edx-cache'
          });
          forageStoreAdapter = (0, _axiosCacheInterceptor.buildStorage)({
              ...
              return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
                ...
                return _regenerator().w(function (_context) {
                  while (1) switch (_context.n) {
                    ...
                    case 1:
                      result = _context.v;
                      return _context.a(2, JSON.parse(result));
                  }
                }, _callee);
              }))();
            },
          ...
          return _context4.a(2, (0, _axiosCacheInterceptor.setupCache)(
          // axios instance
          _axios["default"].create(), {
            ...
            generateKey: _axiosCacheInterceptor.defaultKeyGenerator,
            ...
            headerInterpreter: _axiosCacheInterceptor.defaultHeaderInterpreter,
