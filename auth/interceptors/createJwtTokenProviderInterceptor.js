...
var createJwtTokenProviderInterceptor = function createJwtTokenProviderInterceptor(options) {
  ...
  var interceptor = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(axiosRequestConfig) {
      var requestError, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            ...
            return _context.a(2, axiosRequestConfig);
          case 1:
            _context.p = 1;
            _context.n = 2;
          ...
          case 3:
            _context.p = 3;
            _t = _context.v;
            requestError = Object.create(_t);
            requestError.message = "[getJwtToken] ".concat(requestError.message);
            // Important: return the original axios request config
            requestError.config = axiosRequestConfig;
            return _context.a(2, Promise.reject(requestError));
          case 4:
...
var _default = exports["default"] = createJwtTokenProviderInterceptor;
