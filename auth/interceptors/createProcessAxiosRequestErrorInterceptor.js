...
var createProcessAxiosRequestErrorInterceptor = function createProcessAxiosRequestErrorInterceptor(options) {
  var loggingService = options.loggingService;
    ...
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(error) {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            processedError = (0, _utils.processAxiosError)(error);
            ...
            return _context.a(2, Promise.reject(processedError));
        }
      }, _callee);
    }));
...
var _default = exports["default"] = createProcessAxiosRequestErrorInterceptor;
