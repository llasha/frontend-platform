...
exports.defaultGetBackoffMilliseconds = exports["default"] = void 0;
...
var defaultGetBackoffMilliseconds = exports.defaultGetBackoffMilliseconds = function defaultGetBackoffMilliseconds(nthRetry) {
...
var createRetryInterceptor = function createRetryInterceptor() {
  ...
  var _options$httpClient = options.httpClient,
    httpClient = _options$httpClient === void 0 ? _axios["default"].create() : _options$httpClient,
  ...
  var interceptor = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(error) {
      var config, _config$maxRetries, maxRetries, _retryRequest;
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.n) {
          ...
          case 2:
            ...
            _retryRequest = /*#__PURE__*/function () {
              var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(nthRetry) {
                var retryResponse, backoffDelay, _t;
                return _regenerator().w(function (_context) {
                  while (1) switch (_context.p = _context.n) {
                    ...
                    case 3:
                      retryResponse = _context.v;
                      _context.n = 5;
                      break;
                    case 4:
                      _context.p = 4;
                      _t = _context.v;
                      return _context.a(2, _retryRequest(nthRetry + 1));
                    case 5:
                      return _context.a(2, retryResponse);
                  }
                }, _callee, null, [[1, 4]]);
              }));
            ...
            return _context2.a(2, _retryRequest(1));
        }
      }, _callee2);
    }));
...
var _default = exports["default"] = createRetryInterceptor;
