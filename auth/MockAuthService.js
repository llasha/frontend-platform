...
var userPropTypes = _propTypes["default"].shape({
  userId: _propTypes["default"].string.isRequired,
  username: _propTypes["default"].string.isRequired,
  roles: _propTypes["default"].arrayOf(_propTypes["default"].string),
  administrator: _propTypes["default"]["boolean"]
});
...
var MockAuthService = /*#__PURE__*/function () {
  ...
  function MockAuthService(options) {
    ...
    (0, _utils.ensureDefinedConfig)(options, 'AuthService');
    ...
    this.authenticatedHttpClient = _axios["default"].create();
...
var _default = exports["default"] = MockAuthService;
