...
var AxiosCsrfTokenService = exports["default"] = /*#__PURE__*/function () {
  ...
  return _createClass(AxiosCsrfTokenService, [{
    key: "getCsrfToken",
    value: function () {
      var _getCsrfToken = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(url) {
        var _this = this;
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              try {
                urlParts = (0, _utils.getUrlParts)(url);
              } catch (e) {
                ...
                urlParts = (0, _utils.getUrlParts)(global.location.origin);
              }
            ...
            case 1:
              if (!this.csrfTokenRequestPromises[domain]) {
                ...
                })["catch"](_utils.processAxiosErrorAndThrow)["finally"](function () {
                  delete _this.csrfTokenRequestPromises[domain];
                });
              }
              return _context.a(2, this.csrfTokenRequestPromises[domain]);
          }
        }, _callee, this);
      }));
