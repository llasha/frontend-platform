...
exports.ensureDefinedConfig = ensureDefinedConfig;
exports.getPath = getPath;
exports.getQueryParameters = getQueryParameters;
exports.modifyObjectKeys = modifyObjectKeys;
exports.parseURL = parseURL;
exports.snakeCaseObject = snakeCaseObject;
...
function camelCaseObject(object) {
  return modifyObjectKeys(object, _lodash["default"]);
}
...
function snakeCaseObject(object) {
  return modifyObjectKeys(object, _lodash2["default"]);
}
 ...
 * @returns {Array|Object}
 */
function convertKeyNames(object, nameMap) {
 ...
 */
function ensureDefinedConfig(object, requester) {
