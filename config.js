...
function setConfig(newConfig) {
  (0, _utils.ensureDefinedConfig)(config, 'config');
  config = newConfig;
  (0, _pubSub.publish)(_constants.CONFIG_CHANGED);
}
...
function mergeConfig(newConfig) {
  (0, _utils.ensureDefinedConfig)(newConfig, 'ProcessEnvConfigService');
...
function ensureConfig(keys) {
  ...
  (0, _pubSub.subscribe)(_constants.APP_CONFIG_INITIALIZED, function () {
