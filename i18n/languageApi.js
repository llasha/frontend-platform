...
exports.updateAuthenticatedUserPreferences = updateAuthenticatedUserPreferences;
 ...
 */
function updateAuthenticatedUserPreferences(_x) {
  return _updateAuthenticatedUserPreferences.apply(this, arguments);
}
/**
 ...
 */
function _updateAuthenticatedUserPreferences() {
  _updateAuthenticatedUserPreferences = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(preferenceData) {
    var user, snakeCaseData, formattedData;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          user = (0, _auth.getAuthenticatedUser)();
          if (user) {
            _context.n = 1;
            break;
          }
        ...
        case 1:
          snakeCaseData = (0, _utils.snakeCaseObject)(preferenceData);
          formattedData = (0, _utils.convertKeyNames)(snakeCaseData, {
            pref_lang: 'pref-lang'
          });
          return _context.a(2, (0, _auth.getAuthenticatedHttpClient)().patch("".concat((0, _config.getConfig)().LMS_BASE_URL, "/api/user/v1/preferences/").concat(user.username), formattedData, {
            headers: {
...
function setSessionLanguage(_x2) {
  return _setSessionLanguage.apply(this, arguments);
}
function _setSessionLanguage() {
  _setSessionLanguage = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(languageCode) {
    var formData;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          ...
          return _context2.a(2, (0, _auth.getAuthenticatedHttpClient)().post("".concat((0, _config.getConfig)().LMS_BASE_URL, "/i18n/setlang/"), formData, {
            headers: {
