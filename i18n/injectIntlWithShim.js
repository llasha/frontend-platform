...
var injectIntlWithShim = function injectIntlWithShim(WrappedComponent) {
        ...
        formatMessage: {
          value: function value(definition) {
            ...
            if (definition === undefined || definition.id === undefined) {
              ...
              (0, _lib.getLoggingService)().logError(error);
  ...
  ShimmedIntlComponent.propTypes = {
    intl: _lib.intlShape.isRequired
  };
  return (0, _reactIntl.injectIntl)(ShimmedIntlComponent);
};
var _default = exports["default"] = injectIntlWithShim;
